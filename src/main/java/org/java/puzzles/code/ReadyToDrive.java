...
import org.java.puzzles.tests.ReadyToDriveTest;

public class ReadyToDrive {
    /**
     * We need to write code to check if our electric car is ready to drive. It’s ready to drive if the car's battery is not drained and if it's doors are locked. Write a method which returns true if the car is ready to drive and false if its not ready to drive
     * <p><br/>
